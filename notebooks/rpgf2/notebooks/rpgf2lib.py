...
def run_allocation_analysis(df, quorum_cutoff=5, min_funding=250, total_funding=270000, project_names=None, verbose=False):
    """
    ...
    allocations, eliminated, reasons, stats = get_allocations(
        df, quorum_cutoff, min_funding, total_funding
    )
...
def plot_quorum_sweep(df, quorum_range=range(1, 11), actual_quorum=6, figsize=(12, 5), save_fp=None):
    """
...
def plot_scoring_comparison(df, figsize=(10, 5), save_fp=None):
    """
...
def plot_temperature_analysis(df, hot_cold_pct=0.1, figsize=(12, 5), save_fp=None):
    """
